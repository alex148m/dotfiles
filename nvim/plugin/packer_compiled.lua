...
_G.packer_plugins = {
  ...
  ["cmp-calc"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/cmp-calc",
  ...
  ["cmp-look"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/cmp-look",
  ...
  ["cmp-spell"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/cmp-spell",
